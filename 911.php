...
<body>
   ...
   <div class="men">
      ...
      <div class="col-md-9 single_top">
			...
			<ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="img/911.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="img/911.jpg" class="img-responsive" title="" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="img/911-1.jpg" class="img-responsive" />
								<img class="etalage_source_image" src="img/911-1.jpg" class="img-responsive" title="" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="img/911-2.jpg" class="img-responsive"  />
								<img class="etalage_source_image" src="img/911-2.jpg"class="img-responsive"  />
							</li>
						    <li>
								<img class="etalage_thumb_image" src="img/911-3.jpg" class="img-responsive"  />
								<img class="etalage_source_image" src="img/911-3.jpg"class="img-responsive"  />
							</li>
			 </ul>
		     <div class="clearfix"></div>	
	    </div>
		<div class="cont1 span_2_of_a1">
				...
				<p class="quick_desc">  Game about the difficult work of people that manage emergency lines and services. Your task is to answer incoming calls and to react properly - give first aid instructions, advise, dispatch correct number of firemen / police / ambulances, or sometimes - just ignore the call. Play on ANY CITY in the world!  </p>
			    <div class="wish-list">
				 	<ul>
  ...
  <tr>
    <td>  Windows 7 (64bit)  <br>
Processor: 2 GHz <br>
Memory: 1024 MB RAM<br>
Graphics:NVIDIA 9800 GT 512 MB Video Card or AMD equivalent<br>
