			...
			<ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="img/wo.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="img/wo.jpg" class="img-responsive" title="" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="img/wo1.jpg" class="img-responsive" />
								<img class="etalage_source_image" src="img/wo1.jpg" class="img-responsive" title="" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="img/wo2.jpg" class="img-responsive"  />
								<img class="etalage_source_image" src="img/wo2.jpg"class="img-responsive"  />
							</li>
						    <li>
								<img class="etalage_thumb_image" src="img/wo3.jpg" class="img-responsive"  />
								<img class="etalage_source_image" src="img/wo3.jpg"class="img-responsive"  />
							</li>
			 </ul>
		     <div class="clearfix"></div>	
	    </div>
