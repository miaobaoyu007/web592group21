...
<html>
<head>
<title>Age of Wonders III</title>
...
<body>
   ...
   <div class="men">
      ...
      <div class="col-md-9 single_top">
			...
			<ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="img/wo.png" class="img-responsive" />
									<img class="etalage_source_image" src="img/wo.png" class="img-responsive" title="" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="img/wo1.png" class="img-responsive" />
								<img class="etalage_source_image" src="img/wo1.png" class="img-responsive" title="" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="img/wo2.png" class="img-responsive"  />
								<img class="etalage_source_image" src="img/wo2.png"class="img-responsive"  />
							</li>
						    <li>
								<img class="etalage_thumb_image" src="img/wo3.png" class="img-responsive"  />
								<img class="etalage_source_image" src="img/wo3.png"class="img-responsive"  />
							</li>
			 </ul>
		     <div class="clearfix"></div>	
	    </div>
		<div class="cont1 span_2_of_a1">
				...
				<p class="quick_desc"> Age of Wonders III is the long anticipated sequel to the award-winning strategy series. Delivering a unique mix of Empire Building, Role Playing and Warfare, Age of Wonders III offers the ultimate in turn-based fantasy strategy for veterans of the series and new players alike! </p>
			    <div class="wish-list">
				 	<ul>
			    ...
			    <a href="http://store.steampowered.com/app/250400/" title="Online Reservation" class="btn btn-primary btn-normal btn-inline " target="_self">Buy</a>
			</div>
		    <div class="clearfix"> </div>
		</div>
        <div class="sap_tabs">	
  ...
  <tr>
    <td>Windows XP, Windows Vista, Windows 7, Windows 8, Windows 8.1<br>
Processor: Intel Core 2 Duo E6600 @ 2.4 Ghz or AMD Athlon 64 X2 5000+ @2.6 Ghz<br>
Memory: 2 GB RAM<br>
Graphics:nVidia 8800 / ATi Radeon HD 3870 with 512MB or Laptop integrated Intel HD 3000 with 3GB system ram<br>
