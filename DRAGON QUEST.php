...
<body>
   ...
   <div class="men">
	  ...
	  <div class="dreamcrub">
			...
			<ul id="etalage">
							...
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="img/he.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="img/he2.jpg" class="img-responsive" title="" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="img/he3.jpg" class="img-responsive" />
								<img class="etalage_source_image" src="img/he4.jpg"" class="img-responsive" title="" />
							</li>
		...
		<div class="cont1 span_2_of_a1">
				...
				<p class="quick_desc"> DRAGON QUEST HEROES II is a hack-and-slash Action RPG that sends you on a new adventure to restore order to a once peaceful world filled with monsters and battles of epic proportions. Up to 4 players can play in cooperative multiplayer to defeat an unknown threat looming over the Seven Realms!</p>
			    <div class="wish-list">
				 	<ul>
  ...
  <tr><td> Windows 7/8.1/10 (64bit required) <br>
 Processor:  Core i7 870 2.8GHz or better  <br>
Memory: 4 GB RAM<br>
Graphics: NVIDIA GeForce GTS 450 or AMD Radeon HD 5770 <br>
Storage: 30 GB available space<br>
Sound Card:  DirectX compatible sound card<br></td>
    <td>  Windows 7/8.1/10 (64bit required)  <br>
Processor:  Core i7 2600 3.4GHz or better <br>
Memory: 4 GB RAM<br>
 NVIDIA GeForce GTX 650 Ti or AMD Radeon HD 7870 <br> 
Storage: 30 GB available space<br>
