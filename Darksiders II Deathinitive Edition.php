...
<html>
<head>
<title>Darksiders II Deathinitive Edition</title>
...
<body>
   ...
   <div class="men">
      ...
      <div class="col-md-9 single_top">
			...
			<ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="img/DAR.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="img/DAR.jpg" class="img-responsive" title="" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="img/DAR1.jpg" class="img-responsive" />
								<img class="etalage_source_image" src="img/DAR1.jpg" class="img-responsive" title="" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="img/DAR2.jpg" class="img-responsive"  />
								<img class="etalage_source_image" src="img/DAR2.jpg"class="img-responsive"  />
							</li>
						    <li>
								<img class="etalage_thumb_image" src="img/DAR3.jpg" class="img-responsive"  />
								<img class="etalage_source_image" src="img/DAR3.jpg"class="img-responsive"  />
							</li>
			 </ul>
		     <div class="clearfix"></div>	
	    </div>
		<div class="cont1 span_2_of_a1">
				...
				<p class="quick_desc">  The ultimate DARKSIDERS II experience! 1080p native resolution. Reworked and tuned game balancing and loot distribution. Improved Graphic   </p>
			    <div class="wish-list">
				 	<ul>
  ...
  <tr>
    <td>  Windows XP, Windows Vista SP1, Windows 7, Windows 8 or Windows 10 (64bit)  <br>
Processor:  2.0Ghz Intel® Core™2 Duo Processor or AMD equivalent <br>
Memory: 4 GB RAM<br>
