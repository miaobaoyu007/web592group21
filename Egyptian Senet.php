...
<body>
   ...
   <div class="men">
      ...
      <div class="col-md-9 single_top">
			...
			<ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="img/Sen.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="img/Sen.jpg" class="img-responsive" title="" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="img/Sen1.jpg" class="img-responsive" />
								<img class="etalage_source_image" src="img/Sen1.jpg" class="img-responsive" title="" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="img/Sen2.jpg" class="img-responsive"  />
								<img class="etalage_source_image" src="img/Sen2.jpg"class="img-responsive"  />
							</li>
						    <li>
								<img class="etalage_thumb_image" src="img/Sen3.jpg" class="img-responsive"  />
								<img class="etalage_source_image" src="img/Sen3.jpg"class="img-responsive"  />
							</li>
			 </ul>
		     <div class="clearfix"></div>	
	    </div>
		<div class="cont1 span_2_of_a1">
				...
				<p class="quick_desc"> The #1 SENET Game Is Now Available On Steam. Don't Miss The Opportunity To Play The World's Oldest Board Game From Ancient Egypt. Start Your Mysterious Afterlife Journey To Pass Through The Underworld Realm Of Osiris.  </p>
			    <div class="wish-list">
				 	<ul>
  ...
  <tr>
    <td> Microsoft® Windows 7  <br>
Processor: Intel® Core™ Duo 1.83GHz or faster processor <br>
Memory: 512 MB RAM<br>
Graphics:HD Graphics 4000 or above<br>
Network: Broadband Internet connection<br>
Storage: 80 MB available space<br>
</td>
  </tr>
</table>
</ul>
