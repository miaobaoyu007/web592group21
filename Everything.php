...
<body>
   ...
   <div class="men">
	  ...
	  <div class="dreamcrub">
			...
			<ul id="etalage">
							...
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="img/Ev.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="img/Ev1.jpg" class="img-responsive" title="" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="img/Ev3.jpg" class="img-responsive" />
								<img class="etalage_source_image" src="img/Ev4.jpg"" class="img-responsive" title="" />
							</li>
		...
		<div class="cont1 span_2_of_a1">
				...
				<p class="quick_desc"> Be the Universe in this beautiful interactive nature simulation! Take your mind on an adventure through a vast cosmos filled with thousands of playable characters.</p>
			    <div class="wish-list">
				 	<ul>
  ...
  <tr><td>64-Bit Windows 7 Service Pack 1, or Windows 8 <br>
 Processor: 2 GHz Dual-Core 64-bit CPU <br>
Memory: 8 GB RAM<br>
Graphics: NVIDIA® GeForce® GTX 660 or AMD Radeon™ equivalent <br>
Storage: 2 GB available space<br>
Sound Card: DirectX compatible sound card<br></td>
    <td> 64-Bit Windows 7 Service Pack 1, or Windows 8 <br>
Processor: 2 GHz Dual-Core 64-bit CPU <br>
Memory: 8 GB RAM<br>
NVIDIA NVIDIA® GeForce® GTX 660 or AMD Radeon™ equivalent <br> 
Storage: 2 GB available space<br>
Sound Card: DirectX compatible sound card<br></td>
  </tr>
</table>
