...
<body>
   ...
   <div class="men">
      ...
      <div class="col-md-9 single_top">
			...
			<ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="img/NIE.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="img/NIE.jpg" class="img-responsive" title="" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="img/NIE1.jpg" class="img-responsive" />
								<img class="etalage_source_image" src="img/NIE1.jpg" class="img-responsive" title="" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="img/NIE2.jpg" class="img-responsive"  />
								<img class="etalage_source_image" src="img/NIE2.jpg"class="img-responsive"  />
							</li>
						    <li>
								<img class="etalage_thumb_image" src="img/NIE3.jpg" class="img-responsive"  />
								<img class="etalage_source_image" src="img/NIE3.jpg"class="img-responsive"  />
							</li>
			 </ul>
		     <div class="clearfix"></div>	
	    </div>
		<div class="cont1 span_2_of_a1">
				...
				<p class="quick_desc"> NieR: Automata tells the story of androids 2B, 9S and A2 and their battle to reclaim the machine-driven dystopia overrun by powerful machines.  </p>
			    <div class="wish-list">
				 	<ul>
  ...
  <tr>
    <td>  Windows 7 /8.1 /10 64bit  <br>
Processor: Intel Core i3 2100 or AMD A8-6500 <br>
Memory: 4 GB RAM<br>
Graphics:NVIDIA GeForce GTX 770 VRAM 2GB or AMD Radeon R9 270X VRAM 2GB<br>
