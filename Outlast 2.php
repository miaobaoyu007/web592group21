...
<html>
<head>
<title>Outlast 2: Gameshop</title>
   ...
   <div class="men">
	  ...
	  <div class="dreamcrub">
		...
		<div class="cont1 span_2_of_a1">
				...
				<p class="quick_desc"> Outlast 2 is the sequel to the acclaimed survival horror game Outlast.<br>Set in the same universe as the first game, but with different characters and a different setting, Outlast 2 is a twisted new journey into the depths of the human mind and its dark secrets.<br> 

Outlast 2 introduces you to Sullivan Knoth and his followers, who left our wicked world behind to give birth to Temple Gate, a town, deep in the wilderness and hidden from civilization.<br> Knoth and his flock are preparing for the tribulations of the end of times and you’re right in the thick of it.<br>

You are Blake Langermann, a cameraman working with your wife, Lynn. The two of you are investigative journalists willing to take risks and dig deep to uncover the stories no one else will dare touch.<br> 
...
The investigation has lead you miles into the Arizona desert, to a darkness so deep that no one could shed light upon it, and a corruption so profound that going mad may be the only sane thing to do.</p>
			    <div class="wish-list">
				 	<ul>
  ...
  <tr><td>OS: Windows Vista / 7 / 8 / 10, 64-bits<br>
 Intel Core i3-530<br>
Memory: 4 GB RAM<br>
 1GB VRAM, NVIDIA Geforce GTX 260 / ATI Radeon HD 4870<br>
Storage: 30 GB available space<br>
Sound Card: DirectX compatible sound card<br></td>
    <td>Windows Vista / 7 / 8 / 10, 64-bits<br>
Intel Core i5<br>
Memory: 8 GB RAM<br>
1.5GB VRAM, NVIDIA Geforce GTX 660 / ATI Radeon HD 7850 <br> 
Storage: 30 GB available space<br>
Sound Card: DirectX compatible sound card<br></td>
  </tr>
</table>
	...
	<div class="container" style=>
		...
		<div class="col-md-3">
	     ...
	     <ul class="product">
	      	...
	      	<li class="product_desc">
	      		<h4><a href="ac.php">Outlast 2</a></h4>
