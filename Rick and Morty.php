...
<html>
<head>
<title>Rick and Morty: Virtual Rick-ality</title>
...
<body>
   ...
   <div class="men">
	  ...
	  <div class="dreamcrub">
			...
			<ul id="etalage">
							...
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="img/R.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="img/R2.jpg" class="img-responsive" title="" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="img/R3.jpg" class="img-responsive" />
								<img class="etalage_source_image" src="img/R4.jpg"" class="img-responsive" title="" />
							</li>
		...
		<div class="cont1 span_2_of_a1">
				...
				<p class="quick_desc"> Rick and Morty: Virtual Rick-ality smashes together the absolute VR chaos of the award-winning Job Simulator with the ridiculous, all-out, take-no-prisoners comedy of Rick and Morty.</p>
			    <div class="wish-list">
				 	<ul>
  ...
  <tr><td> Windows 7 SP1 or newer<br>
 Processor:  Intel Core i5-4590 equivalent or  <br>
Memory: 4 GB RAM<br>
Graphics:  GeForce GTX 970 or AMD Radeon RX 480<br>
Storage: 4 GB available space<br>
Sound Card: DirectX compatible sound card<br></td>
    <td> i7-4770 <br>
Processor: Intel Core i5-4590 equivalent or <br>
Memory: 4 GB RAM<br>
NVIDIA GTX 980 equivalent <br> 
