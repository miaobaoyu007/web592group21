...
<html>
<head>
<title>Robot Roller-Derby Disco Dodgeball</title>
...
<body>
   ...
   <div class="men">
	  ...
	  <div class="dreamcrub">
			...
			<ul id="etalage">
							...
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="img/Disco.jpg" class="img-responsive" />
		...
		<div class="cont1 span_2_of_a1">
				...
				<p class="quick_desc"> Race around a dance club / skate park and nail each other with dodgeballs</p>
			    <div class="wish-list">
				 	<ul>
  ...
  <tr><td> Windows XP (Vista not supported) <br>
<br>
Memory: 2 GB RAM<br>
Graphics: Video card supporting shader model 3.0<br>
Storage: 400 MP available space<br></td>
    <td> Win 7, Win 8 <br>
<br>
Memory: 8 GB RAM<br>
NVIDIA Video card supporting shader model 3.0 <br> 
Storage: 400Mp available space<br>
