...
<html>
<head>
<title>STAR WARS™ Empire at War - Gold Pack</title>
...
<body>
   ...
   <div class="men">
      ...
      <div class="col-md-9 single_top">
			...
			<ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="img/SW.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="img/SW.jpg" class="img-responsive" title="" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="img/SW1.jpg" class="img-responsive" />
								<img class="etalage_source_image" src="img/SW1.jpg" class="img-responsive" title="" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="img/SW2.jpg" class="img-responsive"  />
								<img class="etalage_source_image" src="img/SW2.jpg"class="img-responsive"  />
							</li>
						    <li>
								<img class="etalage_thumb_image" src="img/SW3.jpg" class="img-responsive"  />
								<img class="etalage_source_image" src="img/SW3.jpg"class="img-responsive"  />
							</li>
			 </ul>
		     <div class="clearfix"></div>	
	    </div>
		<div class="cont1 span_2_of_a1">
				...
				<p class="quick_desc">  Command or corrupt an entire galaxy in the definitive Star Wars strategy collection. It is a time of galactic civil war. Will you take up the reins of the Rebellion, assume control of the Empire, or rule the Star Wars Underworld? </p>
			    <div class="wish-list">
				 	<ul>
  ...
  <tr>
    <td>  100% DirectX 9.0c compatible computer <br>
Processor:  Intel Pentium III 1.0GHz or AMD Athlon 1.0 GHz <br>
Memory: 512 MP RAM<br>
