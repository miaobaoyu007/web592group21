...
<html>
<head>
<title>How to survie : Gameshop</title>
...
<body>
   ...
   <div class="men">
      ...
      <div class="col-md-9 single_top">
			...
			<ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="how/how.png" class="img-responsive" />
									<img class="etalage_source_image" src="how/how.png" class="img-responsive" title="" />
								</a>
							</li>
							<li>
		...
		<div class="cont1 span_2_of_a1">
				...
				<p class="quick_desc"> “A real Gem” – Destructoid at E3 “Offers a different experience for zombie game veterans” – Co-Optimus“Has a lot more going for it than smashing brains and gory, red goo ... With a surprisingly deep crafting system” – GamesRadarYou're shipwrecked on an isolated island, a desperate castaway in a total </p>
			    <div class="wish-list">
				 	<ul>
  ...
  <tr>
    <td>OS: Windows XP<br>
Processor: Intel Core 2 Duo or better<br>
Memory: 4 GB RAM<br>
Graphics: Ati 5700 series/NVIDIA GeForce GT240 or equivalent<br>
...
90% – Gaming Nexus
		...
		<div class="col-md-3">
	      ...
	      <ul class="product">
	      	<li class="product_img"><img src="images/paladin.jpg" class="img-responsive" alt=""/></li>
	      	<li class="product_desc">
	      		<h4><a href="pala.php">Paladin</a></h4>
	      		<p class="single_price">$25.00</p>
	      		<a href="#" class="link-cart">Add to Wishlist</a>
	        </li>
	      	<div class="clearfix"> </div>
	      </ul>
